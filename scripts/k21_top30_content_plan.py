...
140407:{"model":"تانک کود / مخزن تزریق کود","capacity":"۲۰۰ لیتر","connection":"ورودی و خروجی ۱ اینچ؛ پیش از نصب با نمونه تحویلی تطبیق شود"},
...
140406:{"model":"تانک کود / مخزن تزریق کود","capacity":"۱۰۰ لیتر","connection":"ورودی و خروجی ۳/۴ اینچ؛ پیش از نصب با نمونه تحویلی تطبیق شود"},
...
140014:{"model":"لوله بارانی مه‌پاش","size":"۲ اینچ","length":"۱۰۰ متر","connection":"سرشلنگی/رابط و بست متناسب با لوله ۲ اینچ"},
...
140503:{"model":"زانو پلی‌اتیلن یکسر ماده","size":"لوله ۶۳ میلی‌متر / رزوه ۲ اینچ","material":"پلی‌اتیلن","connection":"پیچی/فشاری × رزوه مادگی"},
