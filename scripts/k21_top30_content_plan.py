...
135235:{"model":"نوار تیپ آبیاری قطره‌ای برای کشت زیر پلاستیک","emitter":"۲۰ سانتی‌متر","filtration":"فیلتر متناسب با کیفیت آب پیش از خط الزامی است؛ مش دقیق با کیفیت آب و دیتاشیت همان رول تعیین شود"},
}

ATTR_NAMES={
 "model":"مدل / نوع محصول","size":"سایز / قطر اسمی","material":"جنس","connection":"نوع اتصال",
 "pressure":"فشار کاری / کلاس فشار","length":"طول","capacity":"ظرفیت","emitter":"فاصله قطره‌چکان","filtration":"فیلتراسیون"
}
